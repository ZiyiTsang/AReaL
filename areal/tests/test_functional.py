...
from areal.utils.functional import (
    compute_is_ratio_with_engine_is,
    ppo_actor_loss_fn,
    sapo_loss_fn,
)
...
class TestEngineISCorrection:
    ...
    def test_token_truncate_2d(self, basic_2d_data):
        ...
        result = compute_is_ratio_with_engine_is(
...
class TestPPOActorLossFnWithEngineIS:
    """Test ppo_actor_loss_fn with engine_is_correction enabled."""
    ...
    def test_no_engine_is_ratio_when_disabled(self):
        ...
        loss, stat = ppo_actor_loss_fn(
            ...
            engine_is_correction=False,
        )

        assert "engine_is_ratio" not in stat

    def test_engine_is_correction_affects_loss(self):
        """Test that enabling engine_is_correction changes the loss value."""
        ...
        # With IS correction: is_ratio = exp(prox - old) = exp(1) ≈ 2.72
